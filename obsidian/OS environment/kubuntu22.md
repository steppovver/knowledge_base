...
sudo apt install qtbase5-dev qt5-qmake cmake qttools5-dev libqt5positioning5 libqt5positioning5-plugins libqt5network5 libqt5concurrent5 qtpositioning5-dev install libqt5websockets5-dev
```